...
//go:generate swagger generate server --target ../../gen --name TaskSchedular --spec ../../swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.TaskSchedularAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.TaskSchedularAPI) http.Handler {
