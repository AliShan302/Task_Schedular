...
func (o *GetTaskByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /task/{ID}] getTaskByID", response, response.Code())
	}
}
...
func (o *GetTaskByIDOK) Error() string {
	return fmt.Sprintf("[GET /task/{ID}][%d] getTaskByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetTaskByIDNotFound) Error() string {
	return fmt.Sprintf("[GET /task/{ID}][%d] getTaskByIdNotFound ", 404)
}
...
// IsSuccess returns true when this get task by Id internal server error response has a 2xx status code
func (o *GetTaskByIDInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get task by Id internal server error response has a 3xx status code
func (o *GetTaskByIDInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get task by Id internal server error response has a 4xx status code
func (o *GetTaskByIDInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get task by Id internal server error response has a 5xx status code
func (o *GetTaskByIDInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get task by Id internal server error response a status code equal to that given
func (o *GetTaskByIDInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get task by Id internal server error response
func (o *GetTaskByIDInternalServerError) Code() int {
	return 500
}

func (o *GetTaskByIDInternalServerError) Error() string {
	return fmt.Sprintf("[GET /task/{ID}][%d] getTaskByIdInternalServerError ", 500)
}

func (o *GetTaskByIDInternalServerError) String() string {
	return fmt.Sprintf("[GET /task/{ID}][%d] getTaskByIdInternalServerError ", 500)
}
